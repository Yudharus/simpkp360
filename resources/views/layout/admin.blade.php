...
<head>
  ...
  <title>Sistem Informasi Manajemen Penilaian Kinerja Pegawai </title>
...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link bg-white">
      <img src="{{ asset('template/dist/img/logobayer.png')}}" alt="logobayer" class="brand-image img-circle elevation-3" style="opacity: .8">
      <span class="brand-text font-weight-light">Bayer Indonesia</span>
    </a>
